...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 01, 2017 at 10:16 PM
...
--
ALTER TABLE `ta_facture_service`
  ADD CONSTRAINT `fk_facture` FOREIGN KEY (`fk_facture`) REFERENCES `facture` (`pk_facture`) ON DELETE CASCADE ON UPDATE CASCADE,
