...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 06 Septembre 2017 à 16:56
...
--
-- Structure de la table `ta_facture_service`
--
...
--
-- Contenu de la table `ta_facture_service`
--
...
--
-- Structure de la table `ta_promotion_service`
--
...
--
-- Contenu de la table `ta_promotion_service`
--
...
--
-- Index pour la table `ta_facture_service`
--
...
--
-- Index pour la table `ta_promotion_service`
--
...
--
-- AUTO_INCREMENT pour la table `ta_facture_service`
--
ALTER TABLE `ta_facture_service`
  MODIFY `pk_facture_service` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
-- AUTO_INCREMENT pour la table `ta_promotion_service`
--
ALTER TABLE `ta_promotion_service`
...
--
-- Contraintes pour la table `ta_facture_service`
--
ALTER TABLE `ta_facture_service`
...
--
-- Contraintes pour la table `ta_promotion_service`
--
ALTER TABLE `ta_promotion_service`
